...
# linux.Hardware()
finalDict.update({'Hardware': linux.Hardware()})
# Software()
# finalDict.update({'Software' : linux.Software()})
# # Driver_Firmware()
# finalDict.update({'Driver_Firmware' : linux.Driver_Firmware()})
# # Services()
# finalDict.update({'Services' : linux.Services()})
# # Hostname_Startup()
finalDict.update({'Hostname_Startup' : linux.Hostname_Startup()})
# MountedDrivers_MappedNetworks()
# finalDict.update({'MountedDrivers_MappedNetworks' : linux.MountedDrivers_MappedNetworks()})
# # Env()
finalDict.update({'Env()' : linux.Env()})
